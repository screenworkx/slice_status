...
class SliceOnOff
{
	...
	public function sliceShow($params) {
		...
		return "<?php if(SliceOnOff::instance()->isOnline($slice_id) OR SliceOnOff::isBackend()$conditions): ?>" .
				$subject . '<?php endif; ?>';
	}
	...
	/**
	  * Lï¿½dt den Online-Status fÃ¼r alle Module aus einem oder mehrere Artikel
	  *
